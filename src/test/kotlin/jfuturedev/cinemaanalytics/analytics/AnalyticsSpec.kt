...
private val chinaFilms = listOf(
    ...
    // 2018
    Film(Country.CHINA, 2018, Month.JANUARY, 2, "", "", setOf(Genre.HISTORY, Genre.SCI_FI)),
    Film(Country.CHINA, 2018, Month.JANUARY, 3, "", "", setOf(Genre.SCI_FI, Genre.COMEDY)),
    Film(Country.CHINA, 2018, Month.JANUARY, 4, "", "", setOf(Genre.SCI_FI, Genre.FANTASY)),
    Film(Country.CHINA, 2018, Month.JANUARY, 1, "", "", setOf(Genre.HISTORY, Genre.COMEDY)),
    Film(Country.CHINA, 2018, Month.JANUARY, 5, "T5", "D5", setOf(Genre.SCI_FI, Genre.COMEDY), 89635352),
    Film(Country.CHINA, 2018, Month.JANUARY, 6, "", "", setOf(Genre.FANTASY)),
    // 2019
    Film(Country.CHINA, 2019, Month.JANUARY, 1, "", "", setOf(Genre.FANTASY, Genre.COMEDY)),
    Film(Country.CHINA, 2019, Month.JANUARY, 2, "", "", setOf(Genre.FANTASY, Genre.SCI_FI)),
    Film(Country.CHINA, 2019, Month.JANUARY, 3, "", "", setOf(Genre.SCI_FI, Genre.COMEDY)),
    Film(Country.CHINA, 2019, Month.JANUARY, 4, "", "", setOf(Genre.COMEDY, Genre.DRAMA)),
    Film(Country.CHINA, 2019, Month.JANUARY, 5, "", "", setOf(Genre.DRAMA, Genre.FANTASY, Genre.COMEDY)),
    Film(Country.CHINA, 2019, Month.JANUARY, 6, "", "", setOf(Genre.DRAMA))
)
...
private val usaFilms = listOf(
    ...
    // 2018
    Film(Country.USA, 2018, Month.JANUARY, 1, "", "", setOf(Genre.DRAMA, Genre.COMEDY)),
    Film(Country.USA, 2018, Month.JANUARY, 2, "", "", setOf(Genre.DRAMA, Genre.SCI_FI)),
    Film(Country.USA, 2018, Month.JANUARY, 3, "T7", "D7", setOf(Genre.DRAMA, Genre.COMEDY), 976534),
    Film(Country.USA, 2018, Month.JANUARY, 4, "", "", setOf(Genre.SCI_FI, Genre.FANTASY)),
    Film(Country.USA, 2018, Month.JANUARY, 5, "", "", setOf(Genre.HISTORY, Genre.COMEDY)),
    Film(Country.USA, 2018, Month.JANUARY, 6, "", "", setOf(Genre.COMEDY)),
    // 2019
    Film(Country.USA, 2019, Month.JANUARY, 1, "", "", setOf(Genre.HISTORY, Genre.COMEDY)),
    Film(Country.USA, 2019, Month.JANUARY, 2, "", "", setOf(Genre.HISTORY, Genre.SCI_FI)),
    Film(Country.USA, 2019, Month.JANUARY, 3, "", "", setOf(Genre.SCI_FI, Genre.COMEDY)),
    Film(Country.USA, 2019, Month.JANUARY, 4, "", "", setOf(Genre.COMEDY, Genre.HISTORY)),
    Film(Country.USA, 2019, Month.JANUARY, 5, "", "", setOf(Genre.FANTASY, Genre.SCI_FI)),
    Film(Country.USA, 2019, Month.JANUARY, 6, "", "", setOf(Genre.DRAMA))
)
...
class AnalyticsSpec : StringSpec({
    ...
    "display top 5 directors of the highest-rated films" {
        Analytics(chinaFilms, usaFilms).runTopDirectors(5) shouldBe Report(
            listOf(
                "D5 (CHINA) / T5 / $89,635,352",
                "D6 (USA) / T6 / $36,548,976",
                "D3 (CHINA) / T3 / $3,456,123",
                "D7 (USA) / T7 / $976,534",
                "D4 (CHINA) / T4 / $625,837"
            )
        )
